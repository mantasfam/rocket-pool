export const ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'minipool', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'enum MinipoolDeposit', name: '_depositType', type: 'uint8' },
      { internalType: 'uint256', name: '_salt', type: 'uint256' },
    ],
    name: 'createMinipool',
    outputs: [{ internalType: 'contract RocketMinipoolInterface', name: '', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'destroyMinipool', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
  ...
  {
    inputs: [{ internalType: 'address', name: '_minipoolAddress', type: 'address' }],
